...
public class Sim {
	...
	public void ricarica(double e) {
		...
		System.out.println("hai ricaricato il numero " + this.telNumber + " di " + e + "$ il nuovo credito é: "
	...
	public void stampaListaChiamate() {
		if (this.chiamate[0] == null) {
			...
			for (int i = 0; i < this.chiamate.length; i++) {
				System.out.println("chiamata durata: " + this.chiamate[i].getDurate() + "al numero: "
						+ this.chiamate[i].getNumeroContattato());
			}
		}
	}
}
